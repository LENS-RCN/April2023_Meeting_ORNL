...
First, let's visualize the GRSM LiDAR data based on a hillshade raster made from the ground elevation data product. NEON has a great tutorial on how to generate such a map [here](https://www.neonscience.org/resources/learning-hub/tutorials/da-viz-neon-lidar-co13flood-r). Note this step might take a bit of time.
...
####specify xlim
plot(GRSMlinearshpy, ylim=c(35.55, 35.75), xlim=c(-83.7,-83.3)
